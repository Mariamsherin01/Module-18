...
## OUTPUT
![image](https://github.com/user-attachments/assets/4b63ceea-f5f8-43a1-bc48-ba02ec2fa238)


##RESULT
Thus, The Python program to find the shortest possible route that visits every city exactly once and returns to the starting point using the **Travelling Salesman Problem (TSP)** approach was implemented and executed successfully.
