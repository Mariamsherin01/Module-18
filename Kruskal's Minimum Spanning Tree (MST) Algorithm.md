...
## OUTPUT
![image](https://github.com/user-attachments/assets/355cf851-2924-447b-a67e-1743b17b1fdb)


## RESULT
Thus, The Python program for **Kruskal's algorithm** to find the Minimum Spanning Tree (MST) of a given connected, undirected, and weighted graph was implemented and executed successfully.
